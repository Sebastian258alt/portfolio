 ...
 * teachingYears: anos a leccionar Inglês (aparece como "mais de N anos").
...
const SITE_CONTENT = {
  pt: {
    ...
    moments: {
      title: "Momentos",
      lead: "Cerimónias e eventos em que participei.",
      source: "Fonte:",
      enlarge: "Ampliar fotografia",
      close: "Fechar",
      certLink: "Ver o certificado",
    },
    documents: {
  ...
  en: {
    ...
    moments: {
      title: "Moments",
      lead: "Ceremonies and events I have taken part in.",
      source: "Source:",
      enlarge: "Enlarge photo",
      close: "Close",
      certLink: "See the certificate",
    },
    documents: {
