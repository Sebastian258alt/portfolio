...
const EXPERIENCE_DATA = [
  {
    ...
    description: {
      pt: "Mais de 4 anos a leccionar Inglês a alunos adultos, do nível iniciante ao intermédio (Níveis 1–4), com foco em aprendizagem estruturada e centrada no aluno.",
      en: "Over 4 years teaching English to adult learners, from beginner to intermediate levels (Levels 1–4), focused on structured, learner-centred instruction.",
    },
    responsibilities: {
      pt: [
