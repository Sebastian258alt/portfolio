...
const SITE_CONTENT = {
  pt: {
    ...
    hero: {
      ...
      intro:
        "Professor de Inglês moçambicano com mais de 6 anos de experiência, finalista de Tradução e Interpretação na Universidade Eduardo Mondlane e com interesse activo em tecnologia e inteligência artificial aplicadas à educação e à comunicação.",
    ...
    documents: {
      ...
      lead: "CV, declarações e portefólio disponíveis para consulta.",
      view: "Visualizar",
    ...
    highlights: {
      title: "Destaques",
      items: [
        { number: "+6", label: "anos de experiência no ensino de Inglês" },
        { number: "+9", label: "certificações profissionais concluídas" },
  ...
  en: {
    ...
    hero: {
      ...
      intro:
        "Mozambican English teacher with over 6 years of experience, final-year Translation and Interpretation student at Eduardo Mondlane University, with an active interest in technology and AI applied to education and communication.",
    ...
    documents: {
      ...
      lead: "CV, statements and portfolio available on request.",
      view: "View",
      download: "Download",
    ...
    highlights: {
      title: "Highlights",
      items: [
        { number: "+6", label: "years of English-teaching experience" },
        { number: "+9", label: "professional certifications completed" },
